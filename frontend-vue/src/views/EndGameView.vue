...
const timeDiff = Math.ceil((new Date(lastGame.endTime).getTime() - new Date(lastGame.startTime).getTime()) / 1000); //in ms
...
<template>
    <main class="vertical">
        <div class="frame" id="name-chooser">
            ...
            <table>
                <tr>
                    <td>times shuffled</td><td>{{ timesShuffled }}</td>
                </tr>
                <tr>
                    <td>cards drawen</td><td>{{ cardsDrawen }}</td>
                </tr>
                <tr>
                    <td>cards played</td><td>{{ cardsPlayed }}</td>
                </tr>
                <tr>
                    <td>time played</td><td>{{ Math.floor(timeDiff / 60) }}min {{ timeDiff % 60 }}s</td>
                </tr>
            </table>
